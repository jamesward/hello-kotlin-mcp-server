 ...
 */
public final class StatelessMcpToolMethodCallback
	...
	public StatelessMcpToolMethodCallback(ReturnMode returnMode, Method toolMethod, Object toolObject) {
    ...
    private boolean isContextType(Class<?> paramType) {
        return McpTransportContext.class.isAssignableFrom(paramType);
    }

	private Object[] buildMethodArguments(McpTransportContext mcpTransportContext, Map<String, Object> toolInputArguments) {
		return Stream.of(this.toolMethod.getParameters()).map(parameter -> {
			Object rawArgument = toolInputArguments.get(parameter.getName());

			if (isContextType(parameter.getType())) {
